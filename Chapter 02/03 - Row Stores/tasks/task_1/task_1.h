...
static inline long run_task_1(size_t num_tuples)
{
    ...
    gs_frag_t *q1 = task_1_scan_impl(lineitem, "quantity", exercice_pred_less, &(uint32_t) {24});
    gs_frag_t *q2 = task_1_scan_impl(q1, "shipdate", exercice_pred_greatereq, &(uint64_t) {1017679567});
    gs_frag_t *q3 = task_1_scan_impl(q2, "discount", exercice_pred_greatereq, &(float) {0.5f});
    gs_frag_t *q4 = task_1_scan_impl(q3, "discount", exercice_pred_lesseq, &(float) {0.7f});
